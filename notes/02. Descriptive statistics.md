- [Descriptive Statistics](#descriptive-statistics)
  ...
  - [3. Plotting Graphs in Statistics](#3-plotting-graphs-in-statistics)
    - [i) Graphs for Univariate Analysis](#i-graphs-for-univariate-analysis)
      ...
      - [a) Numerical Data (Graphical Representation)](#b-numerical-data-visualization)
    - [i) Graphs for Bivariate Analysis](#ii-graphs-for-bivariate-analysis)
      - [a) Categorical- Categorical variables](#a-categorical---categorical-variables)
      - [a) Numerical - Numerical variables](#b-numerical---numerical-variables)
      - [c) Numerical - categorical variables](#c-categorical---numerical-analysis)
  - [4. Five-Number Summary and Box Plot](#4-five-number-summary-and-box-plot)
    - [a) Quartiles](#a-quartiles-q1-q2-q3--4-equal-parts)
    - [b) Deciles](#b-deciles--10-equal-parts)
    - [c) percentiles](#c-percentiles--100-equal-parts)
    - [d) Quintiles](#d-quintiles--5-equal-parts)
    - [Things to remember while calculationg Quantiles](#things-to-remember-while-calculating-quantiles)
    - [Common Percentile Formulas](#1️⃣-common-percentile-formula-for-understanding)
    - [Five number summary](#five-number-summary)
    - [Box plot](#box-plot)
  - [5. Covariance and Correlation](#5-covariance-and-correlation)
    - [a) Covariance](#a-covariance-understanding-the-relationship-between-two-variables)
    - [b) Correlation](#b-correlation-solving-covariances-limitation)
